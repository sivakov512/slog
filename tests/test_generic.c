...
void capture_sink(slog_level_t level, const char *tag, const char *fmt, va_list args, void *user) {
...
static void test_macro_produces_expected_output(void (*log_fn)(void), slog_level_t level) {
  log_fn();
